...
<style>
    ...
    /* Lógica condicional */
    #seccion-reposicion { display: none; }
</style>

<div class="card solicitud-card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
        <h2 style="margin:0; font-size: 1.3rem; color: var(--primary-color);"><i class="fas fa-file-signature"></i> Nueva Solicitud de Permiso</h2>
        <a href="<?php echo URLROOT; ?>/permisos" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Volver</a>
    </div>

    <form action="<?php echo URLROOT; ?>/permisos/solicitar" method="POST" id="form-permiso" enctype="multipart/form-data">
        ...
        <div class="form-section">
            ...
            <div class="grid-solicitud">
                <div class="input-group">
                    ...
                    <input type="date" name="fecha_permiso" required min="<?php echo $data['fecha_minima']; ?>">
                </div>
                <div class="input-group">
                ...
                <div class="input-group" style="display: flex; align-items: center; gap: 0.5rem; padding-top: 1.5rem;">
                    <input type="checkbox" name="regresa_laborar" value="1" checked style="width: auto;">
        ...
        <input type="hidden" name="requiere_reposicion" id="input-requiere-reposicion" value="0">
        <div class="form-section" id="seccion-reposicion">
            ...
            <div class="grid-solicitud">
                <div class="input-group">
                    ...
                    <input type="date" name="reposicion_fecha" id="rep-fecha">
                </div>
                <div class="input-group">
                    <label>Hora de Reposición</label>
                    <input type="time" name="reposicion_hora" id="rep-hora">
                </div>
                <div class="input-group">
                    <label>Observaciones</label>
                    <textarea name="reposicion_observacion" rows="1" placeholder="Detalles de la reposición..."></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="signature-controls">
                <span style="font-size: 0.75rem; color: var(--text-muted);">Use el mouse o el dedo para firmar dentro del cuadro.</span>
            ...
            <input type="hidden" name="firma_digital" id="input-firma" required>
        </div>
