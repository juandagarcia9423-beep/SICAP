            ...
            <div class="grid-form">
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <select name="tipo_personal" required>
                            <option value="planta" <?php echo $data['usuario']->tipo_personal == 'planta' ? 'selected' : ''; ?>>Personal de Planta</option>
                            <option value="administrativo" <?php echo $data['usuario']->tipo_personal == 'administrativo' ? 'selected' : ''; ?>>Personal Administrativo</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="input-group" style="grid-column: span 3; display: flex; gap: 1rem; align-items: center;">
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                        <input type="checkbox" name="permite_pin" value="1" <?php echo $data['usuario']->permite_pin ? 'checked' : ''; ?>> Permitir PIN
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                        <input type="checkbox" name="permite_facial" value="1" <?php echo $data['usuario']->permite_facial ? 'checked' : ''; ?>> Permitir Facial
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                        <input type="checkbox" name="permite_qr" value="1" <?php echo $data['usuario']->permite_qr ? 'checked' : ''; ?>> Permitir QR
                    </label>
                </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        <i class="fas fa-key"></i>
                        <input type="text" name="pin_secreto" value="<?php echo $data['usuario']->pin_secreto; ?>" placeholder="PIN de 4 dígitos">
                    </div>
                </div>
                ...
                <div class="input-group" style="grid-column: span 3; text-align: center;">
                    <div id="facial-setup-container" style="display: flex; flex-direction: column; align-items: center; gap: 1rem; border: 1px dashed #cbd5e1; padding: 1.5rem; border-radius: 12px; background: #f8fafc;">
                        ...
                        <input type="hidden" name="foto_facial" id="foto_facial_input" value="<?php echo $data['usuario']->foto_facial; ?>">
                        
                        <?php if(!empty($data['usuario']->foto_facial)): ?>
                            <div id="current-photo-status" style="font-size: 0.85rem; color: #059669; font-weight: 600;">
                                <i class="fas fa-check-circle"></i> Rostro ya enrolado. Puede volver a capturarlo si lo desea.
                            </div>
                        <?php else: ?>
...
<script>
    ...
    btnCapture.addEventListener('click', () => {
        ...
        statusText.innerHTML = '<i class="fas fa-check-circle"></i> Rostro capturado exitosamente. Guarde los cambios para finalizar.';
