...
<style>
    ...
    table#tabla-bancohoras {
        width: 100% !important;
        border-collapse: collapse !important;
    }

    table#tabla-bancohoras thead th {
    ...
    table#tabla-bancohoras tbody td {
    ...
    .badge-credito { background: #dcfce7; color: #166534; border: 1px solid #bbf7d0; }
    .badge-debito { background: #fee2e2; color: #991b1b; border: 1px solid #fecaca; }
...
<div class="card informe-card">
    <div class="card-header-custom">
        ...
        <div class="no-print">
            ...
            <a href="<?php echo URLROOT; ?>/informes/excel_bancohoras?usuario_id=<?php echo $data['filtros']['usuario_id']; ?>&fecha_inicio=<?php echo $data['filtros']['fecha_inicio']; ?>&fecha_fin=<?php echo $data['filtros']['fecha_fin']; ?>" class="btn btn-success btn-export">
    ...
    <div class="filter-section no-print">
        <form action="<?php echo URLROOT; ?>/informes/bancohoras" method="GET" class="filter-grid">
            ...
            <div style="display: flex; gap: 0.5rem;">
                ...
                <a href="<?php echo URLROOT; ?>/informes/bancohoras" class="btn btn-danger">
    ...
    <div class="table-container">
        <table id="tabla-bancohoras" class="display nowrap">
            <thead>
                <tr>
                    <th>Empleado</th>
                    <th>Fecha</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div style="font-weight: 600;"><?php echo $m->empleado_nombre; ?></div>
                        <div style="font-size: 0.75rem; color: var(--text-muted);"><?php echo $m->cedula; ?></div>
                    </td>
                    <td><?php echo date('d/m/Y H:i', strtotime($m->fecha_movimiento)); ?></td>
                    <td>
                        <span class="badge-tipo badge-<?php echo $m->tipo; ?>">
                            <?php echo $m->tipo; ?>
                        </span>
                    </td>
                    <td style="font-weight: 700;"><?php echo $m->horas; ?> h</td>
                    <td><?php echo $m->concepto; ?></td>
                    <td><?php echo $m->autorizador_nombre ?? '<span class="text-muted">N/A</span>'; ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
